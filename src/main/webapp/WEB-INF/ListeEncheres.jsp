...
<li><a class="nav__links" href="<%=request.getContextPath()%>/log/ServletNewArticle">Vendre un Objet</a></li>
<li><a class="nav__links" href="<%=request.getContextPath()%>/log/ServletAfficherProfil">Mon Profil</a></li>
<li><a class="nav__links" href="<%=request.getContextPath()%>/log/ServletDeconnexion">Déconnexion</a></li>
<%  }else{ %>
